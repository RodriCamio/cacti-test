...
function help() {
    ...
    echo "\n---------------------------------------------------------------------------------------------------\n";
    echo " Copyright (C) 2004-2012 The Cacti Group\n";
...
function autorrdlist($reportid) {
	...
	if (isset($_POST['host_filter']) && $_POST['host_filter'] != 'Any') {
		$sql = $sql . " AND a.name_cache LIKE '%" . $_POST['host_filter'] . "%'";
	}
	if (isset($_POST['text_filter']) && $_POST['text_filter'] != '') {
		$sql = $sql . " AND a.name_cache LIKE '%" . $_POST['text_filter'] . "%'";
	}
