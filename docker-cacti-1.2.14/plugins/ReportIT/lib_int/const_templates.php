...
$template_actions   = array( 1 => 'Delete', 2 => 'Duplicate');

$desc_array         = array('Template Name', 'Data Template', 'Pre-filter', 'Locked', 'Measurands', 'Variables');
$link_array         = array('description', 'data_template_id', 'pre_filter', 'locked', 'measurands', 'variables');
...
$hashes = array("1" => array("reportit" => "c0788d60041d96616d05b87892942948",
