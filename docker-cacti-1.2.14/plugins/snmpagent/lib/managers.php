...
include("./plugins/snmpagent/include/functions.php");
include("./plugins/snmpagent/include/arrays.php");
snmpagent_xss_shield();
...
function manager(){
	...
	html_start_box("<strong>SNMP Notification Receivers</strong>", "100%", $colors["header"], "3", "center", "managers.php?action=edit");
	?>
	<tr bgcolor="#<?php print $colors["panel"];?>">
		<td>
		<form name="form_snmpagent_managers" action="managers.php">
